...
" style="border: 1px solid #f0f0f0;" /></td>
            <td height="35">商品名称：<?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['name']; ?>
</td>
            <td width="156" height="35">商品类别：<?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['class']; ?>
</td>
            <td width="157">商品型号：<?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['model']; ?>
</td>
          </tr>
          <tr>
            <td height="23">商品品牌：<?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['brand']; ?>
</td>
            <td height="23" colspan="2">商品产地：<?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['area']; ?>
</td>
          </tr>
          <tr>
            <td width="178" height="23">剩余数量：<?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['stocks']; ?>
</td>
            <td colspan="2">销售数量：<?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['sell']; ?>
</td>
          </tr>
          <tr>
            <td height="23">市场价：<font color="red"><?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['m_price']; ?>
&nbsp;元</font></td>
            <td height="23" colspan="2">上市日期：<?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['addtime']; ?>
</td>
          </tr>
          <tr>
            <td height="30">会员价格：<font color="#FF0000"><?php echo $this->_tpl_vars['allhot'][$this->_sections['id']['index']]['v_price']; ?>
&nbsp;元</font></td>
